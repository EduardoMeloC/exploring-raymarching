...
\title{Ray March Rendering and its Applications}
...
\advisor[Prof.]{João Antônio Récio da Paixão}{}

% co-orientador é opcional
\coadvisor[Prof.]{João Vitor de Oliveira Silva}{}

% máximo de 3 integrantes da banca (orientador e co-orientador já são adicionados automaticamente)
\banca[Prof.]{Tiago Novello}{}
\banca[Prof.]{Luziane Ferreira de Mendonça}{}
...
\palavraschave{Ray Marching; Renderização de Nuvens; Signed Distance Function; Computação Gráfica}
\end{abstract}
...
\bigskip
% Palavras-chave separadas por ponto e vírgula
\keywords{Ray Marching; Cloud Rendering; Signed Distance Function; Computer Graphics}
\end{englishabstract}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% L I S T A S
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
\makebibspage{abnt}{elementos-postextuais/referencias.bib}
