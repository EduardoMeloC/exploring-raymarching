...
\begin{itemize}
    ...
    \item Taking the maximum between $\mathbf{-d_1}$ and $\mathbf{d_2}$ is like intersecting with the inverse of d1, which means that all $\mathbf{R}^3 $ except object1. This results in the subtraction of objects 1 from 2.
\end{itemize}
