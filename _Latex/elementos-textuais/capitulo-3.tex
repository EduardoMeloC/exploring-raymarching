...
All primitives described in the previous Section were centered at the origin. In order to perform a transformation such as scaling, rotation or translation, it is possible to apply the transformation at the query point $\mathbf{p}$.
...
\begin{itemize}
    ...
    \item Taking the maximum between $\mathbf{-d_1}$ and $\mathbf{d_2}$ is like intersecting with the inverse of d1, which means that all $\mathbb{R}^3 $ except object1. This results in the subtraction of objects 1 from 2.
\end{itemize}
