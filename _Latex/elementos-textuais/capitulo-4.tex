...
\begin{itemize}
    \item If \texttt{p} is \textbf{outside} of the primitive, yields a \textbf{negative} density, or no density.
    \item If \texttt{p} is \textbf{inside} of the primitive, yields a \textbf{positive} density, and the further \texttt{p} is from bounds, the higher density is.
\end{itemize}
