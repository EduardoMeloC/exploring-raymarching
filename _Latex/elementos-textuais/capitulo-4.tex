...
\begin{lstlisting}[language=GLSL, caption={Code 8: Get density of spherical cloud}, label={lst:GetDensity}, float=ht]
float GetDensity(p){
...
\begin{lstlisting}[language=GLSL, caption={Code 9: Lighting the Cloud Volume}, label={CloudVolume} float=ht]
